...
let container
    beforeEach(()=>{
        ...
        const handleToggle = jest.fn()
         container = render(<Blog blog={blog} handleBlogUpdate={handleBlogUpdate} />).container
...
describe('<BlogForm>', ()=>{
    ...
    render(<BlogForm const handleAddBlog={createBlog} handleChange={ handleChange} newBlog={newBlog} />)
